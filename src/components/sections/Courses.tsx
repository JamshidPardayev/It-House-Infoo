            ...
            {data.map((course: CourseType, idx: number) => (
              <SwiperSlide key={idx}>
                <motion.div
                  ...
                  className="bg-gradient-to-br from-white/90 to-gray-100/90 dark:from-gray-800 dark:to-gray-900 shadow-lg dark:shadow-gray-800/40 border border-gray-200 dark:border-gray-700 min-w-[280px] min-h-[700px] rounded-2xl overflow-hidden transition-all cursor-pointer hover:shadow-xl hover:shadow-red-600/20"
                >
                  {/* Image */}
